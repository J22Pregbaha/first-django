...
class HomeTests(TestCase):
	...
	# makes sure the '/' url is returning the home page
	...
	def test_home_view_contains_link_to_topics_page(self):
		...
		#assert if the href value contains a link
...
class BoardTopicsTests(TestCase):
	...
	def test_board_topics_view_contains_link_back_to_homepage(self):
		...
		#test if it contains the link back to the home page
	...
	def NewTopicTests(TestCase):
		def SetUp(self):
			Board.objects.create(name='Django', description='Django board.')
			User.objects.create_user(username='john', email='john@doe.com', password='123') # to create a User instance to be used in the tests
